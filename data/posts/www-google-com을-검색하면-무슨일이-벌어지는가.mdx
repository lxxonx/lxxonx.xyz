...
2. DNS Query
   ...
   <Image
     src="/blog/google/1.png"
     width={1005}
     height={466}
     alt="dns query search"
   />
   <br />
   <a href="https://webhostinggeeks.com/guides/dns/" target="_blank">
     사진 출처
   </a>
...
3. TCP Connection
   ...
   <Image
     src="/blog/google/TCP-connection-1.png"
     width={492}
     height={221}
     alt="tcp handshake"
   />
   <br />
   <a
     href="https://www.geeksforgeeks.org/tcp-3-way-handshake-process/"
     target="_blank"
   >
     사진 출처
   </a>
...
4. HTTP Request
   ...
   <Image
     src="/blog/google/sample-request-header.png"
     width={975}
     height={246}
     alt="http request"
   />
